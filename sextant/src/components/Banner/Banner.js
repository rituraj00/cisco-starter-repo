export default function Banner(){
    ...
    <div className="banner-header">
        <svg className="primary-logo" xmlns="http://www.w3.org/2000/svg" width="108" height="57" viewBox="0 0 108 57" role="img">
        <title id="fw-c-header__logo-title">Cisco.com India</title>
        <defs>
     ...
     <h1 className="banner-header-primary">Sextant</h1>
    </div>
    )
}